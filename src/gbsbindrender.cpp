...
void gbs_bind_render(py::module &m)
{
      ...
      m.def("make_actor",
            py::overload_cast<
                  const gbs::Surface<double,3>&, std::array<double,3>, size_t, size_t
            >(&gbs::make_actor<double,3>),
            "Discretize surface and make actor",
            py::arg("srf"), py::arg("col") = std::array<double,3>{ 51./255.,  161./255.,  201./255.}, py::arg("n1") = 200,py::arg("n2") = 200
      );
      m.def("make_actor",
            py::overload_cast<
                  const gbs::Surface<double,2>&, std::array<double,3>, size_t, size_t
            >(&gbs::make_actor<double,2>),
            "Discretize surface and make actor",
            py::arg("srf"), py::arg("col") = std::array<double,3>{ 51./255.,  161./255.,  201./255.}, py::arg("n1") = 200,py::arg("n2") = 200
      );
      m.def("make_actor",
            py::overload_cast<
                  const gbs::points_vector<double, 3> &, double, bool, std::array<double,3>&
            >(&gbs::make_actor<double,3>),
            "Actor from points",
            py::arg("pts"), py::arg("pt_size") =5., py::arg("render_as_sphere") = true, py::arg("col") = std::array<double,3>{0.3,0.3,0.3}
      );
      m.def("make_actor",
            py::overload_cast<
                  const gbs::points_vector<double, 2> &, double, bool, std::array<double,3>&
            >(&gbs::make_actor<double,2>),
            "Actor from points",
            py::arg("pts"), py::arg("pt_size") =5., py::arg("render_as_sphere") = true, py::arg("col") = std::array<double,3>{0.3,0.3,0.3}
      );
